const en = {
    ...
    bindExternalAccount: 'Bind External Mailbox',
    externalProvider: 'Email provider',
    genericMailbox: 'Generic mailbox',
    oauthBindHint: 'Authorize to receive and send mail with this address. Tokens are stored encrypted.',
    continueProviderAuth: 'Continue authorization',
    externalEmail: 'Email address',
    externalUsername: 'Login username',
    externalPassword: 'App password',
    receiveServer: 'Receiving server',
    sendServer: 'Sending server',
    receiveSecurity: 'Receiving security',
    sendSecurity: 'Sending security',
    port: 'Port',
    testAndBind: 'Test and bind',
    externalRequired: 'Please complete the mailbox and server fields',
    bindingInProgress: 'Finishing mailbox binding',
    bindSuccess: 'Mailbox bound successfully',
    bindFailed: 'Mailbox binding failed',
    externalAccount: 'External mailbox',
    syncExternal: 'Sync now',
    emailAccount: 'Email',
    account: 'Address',
