const zh = {
    ...
    addAccount: '添加邮箱',
    bindExternalAccount: '绑定其他邮箱',
    externalProvider: '邮箱服务商',
    genericMailbox: '通用邮箱',
    oauthBindHint: '授权后即可收取邮件并使用该地址发信，令牌会加密保存。',
    continueProviderAuth: '继续授权',
    externalEmail: '邮箱地址',
    externalUsername: '登录用户名',
    externalPassword: '应用专用密码',
    receiveServer: '收信服务器',
    sendServer: '发信服务器',
    receiveSecurity: '收信加密',
    sendSecurity: '发信加密',
    port: '端口',
    testAndBind: '测试连接并绑定',
    externalRequired: '请填写完整的邮箱和服务器信息',
    bindingInProgress: '正在完成邮箱绑定',
    bindSuccess: '邮箱绑定成功',
    bindFailed: '邮箱绑定失败',
    externalAccount: '外部邮箱',
    syncExternal: '立即同步',
    emailAccount: '邮箱',
    account: '邮箱',
    userAccount: '用户邮箱',
